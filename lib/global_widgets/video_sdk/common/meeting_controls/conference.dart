...
// Meeting ActionBar
class MeetingActionConference extends StatelessWidget {
  // control states
  final bool isMicEnabled, isCamEnabled, isScreenShareEnabled, isHost;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          InkWell(
            onTap: () =>
                isHost ? onCallEndButtonPressed() : onCallLeaveButtonPressed(),
            child: Container(
