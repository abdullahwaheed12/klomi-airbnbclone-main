    ...
    return Column(
      ...
      children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  hintText: "Enter meeting code".tr(),
        ...
        MaterialButton(
            ...
            color: purple,
            child:
                Text("Join Meeting".tr(), style: const TextStyle(fontSize: 16)),
            onPressed: () {
              if (_displayName.trim().isEmpty) {
                showSnackBarMessage(
                    message: "Please enter name".tr(), context: context);
                return;
              }
              if (!widget.isCreateMeeting && _meetingId.trim().isEmpty) {
                showSnackBarMessage(
                    message: "Please enter meeting id".tr(), context: context);
                return;
              }
